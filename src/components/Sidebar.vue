...
<template>
    <div class="Sidebar flex flex-col h-screen w-1/3">
        <div class="worldMap">WorldMap</div>
        <WeatherCard class="local-real-weather">
            <LocalRealWeather />
        </WeatherCard>
        <WeatherCard class="local-preview-weather">
            <LocalCurrentWeather />
        </WeatherCard>
    </div>
</template>
